...
do
  ...
  ocamlfind ocamlopt -g -bin-annot -pp refmt -w "-40-30" -thread -package threads -package ppx_let -package core -package jenga -package yojson -o $destination -I _build/src -c -impl $source
done
...
ocamlfind ocamlopt -o _build/src/rebel -linkpkg -thread -package threads -package ppx_let -package core -package jenga -package yojson -I _build/src $selfSortedArtifactsX
