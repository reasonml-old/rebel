...
ocamlfind ocamlc -custom -o _build/src/rebel -linkpkg -thread -package threads -package ppx_let -package core -package jenga -package yojson -I _build/src $selfSortedArtifacts
