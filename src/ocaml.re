      ...
      mapD (
        fun sortedPaths => Scheme.all [
          ...
          compileSourcesScheme
            ...
            buildDirRoot::(rel dir::build target),
...
let scheme dir::dir =>
  if (dir == Path.the_root) {
    ...
    let target = extractTarget dir::dir;
    let libDir = convertBuildDirToLibDir buildDir::dir target::target;
